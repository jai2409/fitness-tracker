...
st.write("In this WebApp you will be able to observe your predicted calories burned in your body. Pass your parameters such as `Age`, `Gender`, `BMI`")
...
def user_input_features():
    ...
    duration = st.sidebar.slider("Duration (min):", 0, 65, 15)
    heart_rate = st.sidebar.slider("Heart Rate:", 0, 180, 90)
    body_temp = st.sidebar.slider("Body Temperature (C):", 32, 42, 38)
...
calories = pd.read_excel(r"C:\Users\shiva\pft\datasets\calorie.xlsx") 
exercise = pd.read_excel(r"C:\Users\shiva\pft\datasets\workouts.xlsx")
